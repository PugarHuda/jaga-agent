...
Measured on this machine (`npm run backtest`, 2024-08-04T20:00:00Z +12h, 15-min steps, rogue agent on): market ETH -14.6% / BTC -11.1% / SOL -13.4%; buy-and-hold -6.96%, with Jaga -3.18% (worst tick 5.72% down), 13 sells, rogue pumped $4612 into ETH. **Jaga vs holding: +51.62 USDC (+4.06%).** Numbers vary slightly run to run because the rogue agent and the replay clock are real processes, not a script.
